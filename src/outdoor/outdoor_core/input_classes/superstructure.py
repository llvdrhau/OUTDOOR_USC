...
class Superstructure:
    ...
    def __init__(self,
        ...
        self.sourceOrProductLoad = {'source_or_product_load': load}
    ...
    def __fill_betaParameters(self):
        ...
        for i in self.UnitsList:
            if (i.Number in self.CostUnitsList['COSTED_UNIT_OPERATIONS'] and i.Number not in self.HeatGeneratorList["FURNACES"]
                and i.Number not in self.ElectricityGeneratorList['TURBINES']):
