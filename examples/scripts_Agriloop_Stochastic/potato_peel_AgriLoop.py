...
Results_Path = r"/examples/results/potato_peel_case_study"
Results_Path_single = r"/examples/results/potato_peel_case_study/single"
Results_Path_sensitivity = r"/examples/results/potato_peel_case_study/sensitivity"
Results_Path_cross_sensitivity = r"/examples/results/potato_peel_case_study/cross_sensitivity"
Results_Path_stochatic = r"/examples/results/potato_peel_case_study/stochastic"
