...
outdoor.create_superstructure_flowsheet(superstructure_Data,
                                        path=savePathPLots,
                                        saveName='Part_1_Reduced_Superstructure')
...
model_output.get_results(path=results_dir,
                         saveName='Part_1_single_optimization_overview_reduced')
...
analyzer.create_flowsheet(path=savePathPLots,
                          saveName='Part_1_Single_Optimization_design_reduced')

# save the results in a pickle file
fileName = 'Part_1_single_optimization_reduced.pkl'
